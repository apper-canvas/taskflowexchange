...
<div className="flex-1 min-w-0 space-y-2">
          <div className="flex items-start justify-between">
            <h3 className={cn(
              "font-medium text-slate-900 transition-all duration-200 flex-1",
...
<div className="flex items-center justify-between mt-3 text-xs">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            ...
            disabled={isDeleting}
            className="opacity-0 group-hover:opacity-100 p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-full transition-all duration-200 hover:scale-110 hover:rotate-12 focus:outline-none focus:ring-2 focus:ring-red-500/50"
